    ...
    <section className="relative hero h-screen text-white overflow-hidden px-4 py-4 sm:py-8 md:py-12 lg:py-20 xl:py-32">
      <div className="mx-auto max-w-5xl flex flex-col justify-center items-center h-full space-y-12">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          <GradientButton />
          <button className="rounded-full border border-gray-300 bg-[white] text-black px-6 py-3 text-base font-medium cursor-pointer shadow-xl transition-colors hover:bg-gray-50">
            See How It Works
          </button>
        </div>
      </div>
